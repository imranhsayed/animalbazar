...
return $map_script . '<section class="clearfix">
 ...
 <li><a href="javascript:void(0);" id="you_current_location" title="'.__('You Current Location', 'adforest' ).'"><i class="fa fa-crosshairs"></i></a></li>
 <li><a href="javascript:void(0);" id="reset_state" title="'.__('Reset map', 'adforest' ).'">'. __("Reset", "adforest" ).'</a></li>
</ul>
      </section>
				  ';
}
